      ...
      <div className="container px-4 py-6 md:py-10 md:px-12 lg:px-20">
            ...
            <div className="space-y-1">
              ...
              <ul className="space-y-0.5">
                <li>
                  <Link
                    href="/about"
                    className="text-sm hover:text-gray-300 leading-tight"
                  >
                    About us
                  </Link>
                </li>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-4">
            ...
            <div className="space-y-1">
              ...
              <ul className="space-y-0.5">
                ...
                <li>
                  <Link
                    href="/admin"
                    className="text-sm hover:text-gray-300 leading-tight opacity-30 hover:opacity-70"
                  >
                    Admin
                  </Link>
                </li>
            ...
            <div className="col-span-2 mt-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-semibold leading-none mb-2">
                    Media
                  </h3>
          ...
          <div className="space-y-1">
            ...
            <ul className="space-y-0.5">
              ...
              <li>
                <Link
                  href="/admin"
                  className="text-base hover:text-gray-300 leading-tight opacity-30 hover:opacity-70"
                >
                  Admin
                </Link>
              </li>
        ...
        <div className="mt-6 flex flex-col items-center justify-between border-t border-gray-800 pt-4 md:flex-row">
          ...
          <div className="mt-2 flex space-x-4 md:mt-0">
            <Link
              href="/privacy"
              className="text-xs md:text-sm text-gray-400 hover:text-gray-300 leading-tight"
            >
              Privacy
            </Link>
            <Link
